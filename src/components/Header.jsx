...
const Header = () => {
    ...
    return (
        <div>
            <div className='flex justify-between items-center p-3 border-b-2 border-[#0003] shadow-md shadow-gray-300 ml-[64px] w-[calc(100vw-64px)]'>
                <div className='flex justify-center items-center gap-2 bg-white'>
                    <div className='text-[1.5rem] font-[500]'>Chatbot Mind Map</div>
                ...
                <div className='flex justify-center items-center gap-6'>
                    <div className='text-[#2872fa] border-[1px] rounded border-[#2872fa] px-3 py-2 text-[1rem] font-[500] hover:cursor-pointer hover:bg-[#f0f4fc]' onClick={startTour}>GUIDED TOUR</div>
                    <div className='flex justify-center items-center gap-2 cursor-pointer'><p className='text-[1.125rem] font-[400]' alt="View Orgs">SELECT ORG</p> <span className='text-[#2872fa]'><FaAngleDown size={20} /></span></div>
